...
namespace LambAdmin
{
    public partial class DGAdmin
    {
        ...
        public static Dictionary<string, string> DefaultCmdLang = new Dictionary<string, string>()
        {
            ...
            {"command_unlimitedammo_message_on", "^3Unlimited ammo ^2enabled"},
            {"command_unlimitedammo_message_off", "^3Unlimited ammo ^1disabled"},
            {"command_unlimitedammo_message_auto", "^3Unlimited ammo set to ^5auto"},
            ...
            {"command_sentry_usage", "^1Usage: !sentry <player | *filter*>"},
